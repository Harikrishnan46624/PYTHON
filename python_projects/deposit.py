...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print("You have insufficient funds. Your balance is: {}".format(balance))
        else:
            break
    print("You are betting {} on {} lines. Total bet is: {}".format(bet, lines, total_bet))
